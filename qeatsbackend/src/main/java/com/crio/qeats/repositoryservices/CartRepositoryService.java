...
public interface CartRepositoryService {
  ...
  /**
   * xTODO: CRIO_TASK_MODULE_MENUAPI - Add the given cart to the mongodb `carts` collection.
   *
  ...
  /**
   * xTODO: CRIO_TASK_MODULE_MENUAPI - Find and return the cart for the corresponding userId.
   *
   * @param userId - userId
  ...
  /**
   * xTODO: CRIO_TASK_MODULE_MENUAPI - Find and return the cart for the given cartId.
   *
  ...
  /**
   * xTODO: CRIO_TASK_MODULE_MENUAPI - Add the given item to cart with the given cartId.
   *
  ...
  /**
   * xTODO: CRIO_TASK_MODULE_MENUAPI - Remove the given item from cart with the given cartId.
   *
